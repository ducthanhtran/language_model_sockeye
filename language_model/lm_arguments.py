...
def add_model_parameters(parser: argparse.ArgumentParser):
...
#     params_dummy.add_argument('--dummy-type',
#                               type=str,
#                               help='zeros = zero vector, ones = vector with ones')
#     params_dummy.add_argument('--dummy-size',
#                               type=int,
#                               help='size of dummy vector')
#
#
